document.addEventListener("scroll", () => {
  ...
  const animations = [
    ...
    { id: "counter3", position: 800, animation: "counter3 3s forwards" },
    { id: "counter5", position: 1000, animation: "counter5 3s forwards" },
    { id: "counter4", position: 2350, animation: "counter4 3s forwards" },
  ];
