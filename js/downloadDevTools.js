...
function showOS(osName){
    ...
    switch(osName){
        ...
        case 'MacOS':
            ...
            downloadLink = `Play-Epik-Inc/Taskify-Business/releases/download/v${version}/Taskify-Business-Setup-${version}.dmg`;
            break;
        case 'Linux':
            windows.style.display = "none";
            macOS.style.display = "none";
            ...
            downloadLink = `Play-Epik-Inc/Taskify-Business/releases/download/v${version}/Taskify-Business-Setup-${version}.AppImage`;
            break;
    }
}
